...
import { getTeamsWithLatestSeason } from '@/lib/getTeams'
import { Plus } from 'lucide-react'
import Link from 'next/link'
import TeamsAdminTable from './TeamsAdminTable'

export default async function TeamsAdminPage() {
  const school = await getSchool()
  if (!school) return null

  const teams = await getTeamsWithLatestSeason(school.id)
      ...
      {teams.length === 0 && (
          <div className="bg-white rounded-2xl p-20 text-center border border-dashed border-gray-100 shadow-soft">
              <div className="flex flex-col items-center max-w-sm mx-auto">
                  ...
                  <h3 className="text-xl font-black text-gray-900 mb-1">No Teams Found</h3>
