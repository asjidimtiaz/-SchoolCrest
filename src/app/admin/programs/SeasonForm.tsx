...
interface SeasonFormProps {
    program_id: string
    schoolId?: string
    season?: ProgramSeason // For editing
...
export default function SeasonForm({ program_id, schoolId, season, suggestedYear, onSuccess }: SeasonFormProps) {
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                    <div className="flex items-center gap-2">
                        ...
                        <label className="text-[10px] font-black tracking-[0.2em] text-gray-400 uppercase">Season Program Photo</label>
                    </div>
                    <MediaUpload
                ...
                <div className="bg-white p-6 rounded-[2.5rem] border border-gray-100 shadow-soft space-y-5">
                    <div className="flex items-center gap-2">
                        <div className="w-1.5 h-1.5 rounded-full bg-blue-500" />
                        <label className="text-[10px] font-black tracking-[0.2em] text-gray-400 uppercase">Program Roster</label>
                    </div>
